module github.com/unistack-org/micro-examples/grpc
...
require (
	...
	go.unistack.org/micro-client-grpc/v3 v3.9.0
	...
	go.unistack.org/micro-server-grpc/v3 v3.9.7
	go.unistack.org/micro-server-http/v3 v3.10.2
	go.unistack.org/micro-tracer-opentracing/v3 v3.8.0
